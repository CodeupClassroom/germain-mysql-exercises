...
################ Initial Data Summarization and Explorization #############
...
-- Return only the unique values from the class column. Now what does a single row represent? Our result set contains much less detail. Zoom out. (Returns 3 rows.)
SELECT
    DISTINCT class
FROM passengers;
